...
///
/// Uses the [`notify_rust`] crate which talks D-Bus directly on Linux
        ...
        #[cfg(target_os = "macos")]
        {
                ...
                .output()
            {
                ...
                Ok(out) => {
                    ...
                    debug!(error = %stderr, "osascript notification failed; trying notify_rust");
                }
                Err(e) => {
                    debug!(error = %e, "osascript not available; trying notify_rust");
                }
            }
        }
